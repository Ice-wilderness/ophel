...
- **跨站点会话搜索** — 全局搜索现在也能搜到其他已适配站点的会话，结果带来源站点图标和「站外」标注，点击后在新标签页打开。(#888)
- **Gemini Spark 会话同步** — Gemini Spark（gemini.google.com/spark）的任务会话现在可以同步进会话管理，置顶状态一并保留，点击即可打开对应会话。(#902)
...
- **Claude 会话切 Key 体验** — 切换 Session Key 时优先仅刷新当前发起请求的标签页，不再重载其他打开的 Claude 标签页，避免打断其他会话与未保存草稿。
