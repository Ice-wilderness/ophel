export const en = {
  ...
  sitePacksTabBuiltin: "Built-in sites",
  builtinSitesDesc:
  ...
  disableSiteConfirmAction: "Disable & reload",
  ...
  sitePacksUninstallKeepData: "Site settings and chat data are kept.",
  ...
  permissionStorageDesc: "Used to save extension settings, prompts, and chat data.",
  ...
  conversationsSettingsDesc: "Configure chat sync and display",
  readingHistoryDesc: "Track and restore chat reading positions",
  day: "day",
  days: "days",
  forever: "Forever",
  ...
  usageMonitorDailyLimitLabel: "Estimated daily chat limit",
  ...
  clearAllDataDesc: "Caution: This will remove all local settings, prompts and chats.",
  clearAllDataConfirm:
    "Are you sure you want to clear all data? This works is irreversible and all settings, prompts, chats will be deleted!",
  ...
  promptDeleteConfirm: "This prompt will be permanently deleted.",
  ...
  chainDeleteConfirm: "This chain will be permanently deleted.",
  chainAdd: "Add Chain",
  ...
  geminiMystuffLocateFailed: "Original chat location not found",
  ...
  exportStyleDesc: "Clean style removes decorative emojis from exported files",
  exportStyleStandard: "Standard",
  exportStyleClean: "Clean",
  exportStyleCleanOption: "Use clean style (no decorative emojis)",
  exportImageAlt: "Image",
  ...
  exportConversationTitle: "Export Chat",
  exporting: "Exporting...",
  ...
  autoRenameTabDesc: "Change browser tab title to current chat name",
  renameIntervalLabel: "Detection Interval",
  renameIntervalDesc: "Interval for detecting chat name changes",
  secondsSuffix: "s",
  ...
  privacyModeDesc: "Hide real chat title, show decoy title",
  ...
  refreshConversations: "Refresh chats",
  syncingConversations: "Syncing chats...",
  grokSyncingConversations: "Syncing chats, please wait...",
  // Tab Order Settings
  ...
  outlineAutoUpdateLabel: "Auto-update outline during chat",
  ...
  outlineShowWordCountDesc:
    "Display word count for each section in outline tooltip. May affect extension performance in long chats.",
  words: "words",
  ...
  toggleConversations: "Toggle Chats",
  // Conversations
  tabConversations: "Chats",
  conversationsEmpty: "No chats yet",
  ...
  conversationsDeleteConfirm: 'Delete folder "{folder}"? Chats will be moved to {inbox}.',
  ...
  conversationsSyncEmpty: "No chats found",
  conversationsSyncNoChange: "No new chats",
  conversationsSyncNoSidebarItems:
    "No chats detected in sidebar. Expand/open the sidebar and try again.",
  conversationsSyncResult:
    "Sync complete: {scanned} scanned, {added} added, {updated} updated, {deleted} deleted",
  conversationsUnsupportedTitle: "{site} chats not supported",
  conversationsUnsupportedDesc:
    "Current site restrictions prevent reliably fetching the chat list.",
  conversationsUnsupportedSync: "{site} chats are not supported for sync.",
  conversationsLocate: "Locate current chat",
  conversationsLocateSuccess: "Located current chat",
  conversationsLocateNotFound: "Current chat not tracked, syncing...",
  conversationsLocateNewChat: "This is a new chat, not yet saved",
  conversationsLocateSyncFailed: "Chat not found after sync",
  justNow: "Just now",
  minutesAgo: "min ago",
  hoursAgo: "hr ago",
  daysAgo: "days ago",
  conversationsSelectFolder: "Select Sync Folder",
  conversationsMoveTo: "Move Chat",
  conversationsSetTag: "Set Tag",
  conversationsMoved: "Moved to",
  conversationsSyncDeleteTitle: "Sync Delete",
  conversationsSyncDeleteMsg: "Detected {count} chats deleted in cloud. Sync delete local records?",
  deleteConvRemoteError: "Removed from panel, but cloud deletion failed",
  conversationsDeleted: "Removed",
  // Conversation Settings
  conversationsSettingsTitle: "Chat Settings",
  conversationsSyncUnpinLabel: "Sync Unpin Status",
  conversationsSyncUnpinDesc: "Unpin local chat if unpinned in cloud during sync",
  ...
  conversationsSyncDeleteDesc:
    "Delete cloud chat on the corresponding site when deleting local record",
  ...
  exportNeedOpenFirst: "Please open the chat first",
  ...
  conversationsRefresh: "Refresh chats",
  conversationsSearchFolder: "Search folder...",
  conversationsSearchPlaceholder: "Search chats...",
  ...
  dataManagementNote:
    "Note: The exported file contains all settings, chat records, etc. Can be used for backup or migration to new devices.",
...
Please output the optimized code block directly, followed by a brief summary of improvements.`,
  ...
  shortcutNewConversation: "New Chat",
  shortcutRefreshConversations: "Refresh Chats",
  shortcutLocateConversation: "Locate Current Chat",
  shortcutPrevConversation: "Previous Chat",
  shortcutNextConversation: "Next Chat",
  shortcutExportConversation: "Export Chat",
  ...
  conversationsRefreshed: "Chats refreshed",
  locatingOutline: "Locating in outline...",
  locatingConversation: "Locating current chat...",
  noConversationToLocate: "No chat to locate",
  outlineDisabled: "Outline feature is disabled",
  conversationsDisabled: "Chats feature is disabled",
  exportStarted: "Exporting chat, please do not interact with this page...",
  exportOverlayLoadingHistory: "Loading full chat...",
  exportOverlayPreparing: "Preparing export...",
  exportOverlayExtracting: "Extracting chat...",
  ...
  outlineCopyOverlayLoadingHistory: "Loading full chat...",
  ...
  chatgptCodeBlockBatchMountDesc:
    "Mount code editors in batches when opening or switching long chats to reduce page freezes",
  ...
  chatgptDisableBackdropBlurDesc:
    "Turn off backdrop blur effects to reduce frame drops when scrolling long chats; slightly changes the page appearance",
  ...
  popupSiteDisabled: "Disabled",
  popupEnableOnThisSite: "Enable on this site",
  popupToggleOphelOnSite: "Toggle Ophel on this site",
  popupSiteDisabledHint: "Ophel enhancements are disabled on this site",
  popupSiteDisabledToast: "Disabled. Reload the page for it to fully take effect",
  popupSiteEnabledToast: "Enabled",
  popupPackEnabledToast: "Site pack {site} enabled; reload open pages to apply",
  popupPackDisabledToast: "Site pack {site} disabled; reload open pages to apply",
  popupSiteTileDisabledTooltip: "Ophel is disabled on this site; click to open it anyway",
  ...
  globalSearchCategoryConversations: "Chats",
  ...
  globalSearchPlaceholderConversations: "Search chats on current site",
  ...
  globalSearchEmptyConversations: "No chat results",
  ...
  queueEmpty: "Queue is empty. Type and press {key} to send or enqueue.",
  selectNoOptions: "No options",
  activeSearchFilters: "Active search filters",
  queueClearAll: "Clear Queue",
  queueRemove: "Remove",
  queuePlaceholderIdle: "Type a prompt, {key} to send...",
  queuePlaceholderBusy: "AI is generating, {key} to enqueue...",
  ...
  queueEditedNotSent: "Editor content changed; the queued item was not sent",
  ...
  zenModeDesc:
    "Hide sidebar and navigation elements to focus on the current chat (configured independently for each site)",
  ...
  "featureTip-export-conv-title": "Export Chats",
  "featureTip-export-conv-desc": "Export selected chats as Markdown / JSON / TXT",
  "featureTip-export-conv-path": "Chats Tab → top-right Batch Mode → Export in bottom bar",
  "featureTip-batch-select-title": "Batch Manage Chats",
  "featureTip-batch-select-desc": "Bulk delete, export, archive, or move chats",
  "featureTip-batch-select-path": "Chats Tab → top-right Batch Mode",
  "featureTip-export-markdown-title": "Export Current Chat",
  "featureTip-export-markdown-desc": "Export the current page chat as a Markdown file",
  ...
  remoteConfigPrivacyDesc:
    "Update checks only send GET requests to static CDNs. No chat or account data is included.",
