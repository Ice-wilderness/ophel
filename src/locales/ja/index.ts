export const ja = {
  ...
  promptDeleteConfirm: "このプロンプトは完全に削除されます。",
  ...
  chainDeleteConfirm: "この Chain は完全に削除されます。",
  chainAdd: "Chain を追加",
...
最適化されたコードブロックを直接出力し、その後に改善点の簡潔な要約を添えてください。`,
  ...
  exportStyleLabel: "エクスポートスタイル",
  exportStyleDesc: "クリーンスタイルはエクスポートされたファイルから装飾絵文字を削除します",
  exportStyleStandard: "標準",
  exportStyleClean: "クリーン",
  exportStyleCleanOption: "クリーンスタイルを使用（装飾絵文字なし）",
  exportImageAlt: "画像",
  ...
  queueEmpty: "キューは空です。入力して{key}で送信または追加",
  selectNoOptions: "選択肢がありません",
  activeSearchFilters: "有効な検索フィルター",
  queueClearAll: "すべてクリア",
  queueRemove: "削除",
  queuePlaceholderIdle: "プロンプトを入力し、{key}で直接送信...",
  queuePlaceholderBusy: "AI生成中、{key}でキューに追加...",
  ...
  queueEditedNotSent: "入力内容が変更されたため、このキュー項目は送信されませんでした",
  queueForceSend: "強制送信",
