export const fr = {
  ...
  disclaimerAffiliation:
    "Cette extension n'est ni affiliée officiellement ni approuvée par les sites pris en charge ; toutes les marques et tous les noms appartiennent à leurs propriétaires respectifs.",
  disclaimerAgreeNote:
    "En cliquant sur le bouton ci-dessus, vous confirmez avoir lu, compris et accepté ce qui précède.",
  disclaimerContribute: "Contribuer",
  ...
  sitePacksTabBuiltin: "Sites intégrés",
  builtinSitesDesc:
    "Gérez les sites IA intégrés sur lesquels Ophel est actif. Une fois désactivé, le panneau et toutes les améliorations ne se chargent plus sur ce site ; rechargez les pages ouvertes pour appliquer complètement le changement",
  builtinSiteBadge: "Intégré",
  builtinSiteCurrentBadge: "Site actuel",
  builtinSiteEnabledToast: "{site} réactivé",
  builtinSiteDisabledToast:
    "Ophel désactivé sur {site} ; rechargez les pages ouvertes pour appliquer complètement le changement",
  disableSiteEntryLabel: "Désactiver Ophel sur ce site",
  disableSiteConfirmTitle: "Désactiver Ophel sur {site} ?",
  disableSiteConfirmDesc:
    "Supprime le panneau et tous les moniteurs en arrière-plan de cette page, puis la recharge pour appliquer complètement la désactivation. Pour réactiver, allez dans Centre d'adaptation → Sites intégrés",
  disableSiteConfirmAction: "Désactiver et recharger",
  ...
  version: "Version",
  aboutDescription:
    "{appName} est une extension de navigateur pour les plateformes d'IA comme ChatGPT, Claude, Gemini, DeepSeek et Doubao, extensible à d'autres sites grâce aux packs d'adaptateurs (règles JSON). Elle offre gestion des conversations, export multi-format, plans intelligents, recherche globale et files de prompts, ainsi que reprise de lecture, rendu et copie de formules, alertes de fin de réponse, verrouillage du modèle et ajustement de la mise en page. Avec les thèmes, le mode Zen et la synchronisation WebDAV, elle rend vos interactions avec l'IA plus fluides et agréables.",
  ...
  githubDesc: "Ajoutez une étoile au dépôt pour soutenir le développement",
  ...
  promptDeleteConfirm: "Ce prompt sera définitivement supprimé.",
  ...
  chainDeleteConfirm: "Cette chain sera définitivement supprimée.",
...
Donnez le code puis un résumé des améliorations.`,
  ...
  shortcutConflict: 'En conflit avec "{name}"',
  ...
  exportStyleLabel: "Style d'export",
  exportStyleDesc: "Le style épuré supprime les émojis décoratifs des fichiers exportés",
  exportStyleStandard: "Standard",
  exportStyleClean: "Épuré",
  exportStyleCleanOption: "Utiliser le style épuré (sans émojis décoratifs)",
  ...
  popupSiteDisabled: "Désactivé",
  popupEnableOnThisSite: "Activer sur ce site",
  popupToggleOphelOnSite: "Activer ou désactiver Ophel sur ce site",
  popupSiteDisabledHint: "Les fonctionnalités d'Ophel sont désactivées sur ce site",
  popupSiteDisabledToast: "Désactivé. Rechargez la page pour une prise d'effet complète",
  popupSiteEnabledToast: "Activé",
  popupPackEnabledToast: "Pack de site {site} activé ; rechargez les pages ouvertes pour appliquer",
  popupPackDisabledToast:
    "Pack de site {site} désactivé ; rechargez les pages ouvertes pour appliquer",
  popupSiteTileDisabledTooltip:
    "Ophel est désactivé sur ce site ; cliquez pour l'ouvrir quand même",
  popupQuickAccess: "Accès Rapide",
  popupSitePackUnbound: "Aucun site ajouté",
  popupSwitchSiteEntry: "Changer d'entrée du site",
  ...
  queueEmpty: "La file est vide. Saisissez et appuyez sur {key} pour envoyer ou ajouter",
  selectNoOptions: "Aucune option",
  activeSearchFilters: "Filtres de recherche actifs",
  queueClearAll: "Tout effacer",
  queueRemove: "Retirer",
  queuePlaceholderIdle: "Saisissez le prompt, {key} pour envoyer direct...",
  queuePlaceholderBusy: "IA génère, {key} pour ajouter à la file...",
  ...
  queueEditedNotSent: "Le contenu de l'éditeur a changé ; l'élément en file n'a pas été envoyé",
  ...
  joinDiscordCommunity: "Rejoindre Discord",
  kofiSupport: "Soutenir sur Ko-fi",
  kofiDesc: "Si Ophel vous est utile, pensez à offrir un café pour soutenir le développeur",
  kofiBtn: "Soutenir sur Ko-fi",
  sponsorSupport: "Soutenir le projet",
  sponsorDesc: "Si Ophel vous est utile, pensez à soutenir le développement",
  wechatPay: "WeChat Pay",
  alipayPay: "Alipay",
  afdianSupport: "Afdian",
  afdianCardDesc: "Soutenir le développement continu",
}
