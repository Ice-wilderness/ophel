export const ko = {
  ...
  promptDeleteConfirm: "이 프롬프트는 영구적으로 삭제됩니다.",
  ...
  chainDeleteConfirm: "이 Chain은 영구적으로 삭제됩니다.",
  chainAdd: "Chain 추가",
...
최적화된 코드 블록을 직접 출력하고, 그 뒤에 개선 사항을 간략히 요약해 주세요.`,
  ...
  exportStyleLabel: "내보내기 스타일",
  exportStyleDesc: "클린 스타일은 내보낸 파일에서 장식 이모지를 제거합니다",
  exportStyleStandard: "표준",
  exportStyleClean: "클린",
  exportStyleCleanOption: "클린 스타일 (장식 이모지 제거)",
  exportImageAlt: "이미지",
  ...
  queueEmpty: "대기열이 비어 있습니다. 입력 후 {key}를 눌러 보내거나 대기열에 추가하세요",
  selectNoOptions: "옵션 없음",
  activeSearchFilters: "활성 검색 필터",
  queueClearAll: "모두 지우기",
  queueRemove: "제거",
  queuePlaceholderIdle: "프롬프트를 입력하고 {key}를 눌러 전송...",
  queuePlaceholderBusy: "AI 생성 중, {key}를 눌러 대기열에 추가...",
  ...
  queueEditSave: "저장",
  queueEditCancel: "취소",
  queueEditedNotSent: "편집 내용이 변경되어 이 큐 항목이 전송되지 않았습니다",
