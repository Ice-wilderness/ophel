export const ru = {
  ...
  disclaimerAffiliation:
    "Это расширение официально не связано с поддерживаемыми сайтами и не одобрено ими; все торговые марки и названия принадлежат их правообладателям.",
  disclaimerAgreeNote:
    "Нажимая кнопку выше, вы подтверждаете, что прочитали, поняли и принимаете изложенное выше.",
  disclaimerContribute: "Участвовать",
  ...
  builtinSiteCurrentBadge: "Текущий сайт",
  ...
  version: "Версия",
  aboutDescription:
    "{appName} — браузерное расширение для ИИ-платформ вроде ChatGPT, Claude, Gemini, DeepSeek и Doubao, расширяемое на другие сайты пакетами адаптеров (JSON-правил). Оно предлагает управление диалогами, экспорт в нескольких форматах, умные оглавления, глобальный поиск и очереди промптов, а также восстановление прогресса чтения, рендеринг и копирование формул, уведомления о завершении, блокировку модели и настройку макета. Темы, дзен-режим и синхронизация WebDAV делают работу с ИИ комфортнее.",
  ...
  githubDesc: "Поставьте звезду репозиторию, чтобы поддержать развитие",
  ...
  promptDeleteConfirm: "Этот промпт будет удалён безвозвратно.",
  ...
  chainDeleteConfirm: "Эта chain будет удалена безвозвратно.",
...
Выдай код и кратко, что стало лучше.`,
  ...
  shortcutConflict: 'Конфликтует с "{name}"',
  ...
  exportStyleLabel: "Стиль экспорта",
  exportStyleDesc: "Чистый стиль убирает декоративные эмодзи из экспортированных файлов",
  exportStyleStandard: "Стандартный",
  exportStyleClean: "Чистый",
  exportStyleCleanOption: "Чистый стиль (без декоративных эмодзи)",
  exportImageAlt: "Изображение",
  ...
  queueEmpty: "Очередь пуста. Введите и нажмите {key} для отправки или добавления",
  selectNoOptions: "Нет вариантов",
  activeSearchFilters: "Активные фильтры поиска",
  queueClearAll: "Очистить всё",
  queueRemove: "Удалить",
  queuePlaceholderIdle: "Введите промпт, {key} для отправки...",
  queuePlaceholderBusy: "ИИ генерирует, {key} для добавления в очередь...",
  ...
  queueEditedNotSent: "Содержимое редактора изменилось; элемент очереди не был отправлен",
  ...
  joinDiscordCommunity: "Присоединиться к Discord",
  kofiSupport: "Поддержать на Ko-fi",
  kofiDesc: "Если Ophel оказался вам полезен, вы можете угостить разработчика кофе",
  kofiBtn: "Поддержать на Ko-fi",
  sponsorSupport: "Поддержать проект",
  sponsorDesc: "Если Ophel вам полезен, поддержите дальнейшую разработку",
  wechatPay: "WeChat Pay",
  alipayPay: "Alipay",
  afdianSupport: "Afdian",
  afdianCardDesc: "Поддержите дальнейшую разработку",
}
